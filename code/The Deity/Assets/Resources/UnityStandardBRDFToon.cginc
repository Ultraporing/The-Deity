...
#ifndef UNITY_STANDARD_BRDF_CUSTOM_INCLUDED
#define UNITY_STANDARD_BRDF_CUSTOM_INCLUDED
    ...
    UnityLight light, UnityIndirect gi)
{
    ...
    half nh = smoothstep(0.0, 0.05, saturate(dot(normal, halfDir)));
    half nv = smoothstep(0.0, 0.05, saturate(dot(normal, viewDir)));
    half lh = smoothstep(0.0, 0.05, saturate(dot(light.dir, halfDir)));
